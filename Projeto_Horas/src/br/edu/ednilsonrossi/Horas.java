...
public class Horas {
	private static final int dayInSeconds = 86399;		// 86399s == 1 dia
	private static final int hoursInSeconds = 3600;	// 3600s == 1 hora 
	private static final int minutesInSeconds = 60;	// 60s == 1 minuto
	private int seconds;
